...
class NavbarServiceProvider extends NavbarServiceProvider__AopProxied implements \Go\Aop\Proxy
{
    /**
...
\Go\Proxy\ClassProxyGenerator::injectJoinPoints(NavbarServiceProvider::class);