...
class AuthServiceProvider extends AuthServiceProvider__AopProxied implements \Go\Aop\Proxy
{
    /**
    ...
    {
        return self::$__joinPoints['method:registerPolicies']->__invoke($this);
    }
    ...
    {
        return self::$__joinPoints['method:policies']->__invoke($this);
    }
...
\Go\Proxy\ClassProxyGenerator::injectJoinPoints(AuthServiceProvider::class);